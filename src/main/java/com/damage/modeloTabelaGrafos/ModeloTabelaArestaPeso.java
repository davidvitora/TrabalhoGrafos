 ...
 * @author David .V
 */
public class ModeloTabelaArestaPeso extends AbstractTableModel{
    
    private VectorAresta<Aresta> arestas;
    String colunas[] = {"Aresta","Peso"};
    
    public ModeloTabelaArestaPeso(VectorAresta<Aresta> arestas){
